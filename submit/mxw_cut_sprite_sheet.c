...
/*   Updated: 2024/06/06 17:15:19 by tookuyam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_mxw_image	*mxw_cut_spritesheet(t_mxw *mxw, t_mxw_spritesheet *sheet,
	int x, int y)
{
	t_mxw_image				*image;
	t_mxw_cut_image_param	*param;
