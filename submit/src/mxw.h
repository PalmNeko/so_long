...
/*   Updated: 2024/06/02 21:05:32 by tookuyam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	mxw_start(int (*setup)(), int (*loop)(), void *setup_args, void *loop_args);
...
t_mxw_image		*mxw_xpm_file_to_image(
		t_mxw *mxw, char *filename, int *width, int *height);
int				mxw_destroy_image(t_mxw *mxw, t_mxw_image *img);
int				mxw_put_image_to_image(t_mxw_image *canvas, t_mxw_image *image, int x, int y);
